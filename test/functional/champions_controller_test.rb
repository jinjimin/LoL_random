...
class ChampionsControllerTest < ActionController::TestCase
  ...
  test "should create champion" do
    assert_difference('Champion.count') do
      post :create, :champion => { :guide_url => @champion.guide_url, :image_url => @champion.image_url, :name => @champion.name }
    end
  ...
  test "should update champion" do
    put :update, :id => @champion, :champion => { :guide_url => @champion.guide_url, :image_url => @champion.image_url, :name => @champion.name }
    assert_redirected_to champion_path(assigns(:champion))
  end
